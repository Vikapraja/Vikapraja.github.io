                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <div className="text-white mt-4 d-flex flex-column contact-link">
                            ...
                            <Link to="tel:+919873848046" target='_blank' rel='noreferrer' className="py-3 text-light border-bottom border-primary"><i className="fas fa-phone-alt text-secondary me-2"></i> +91-9873848046</Link>
                            <Link to="https://wa.me/+919873848046" target='_blank' rel='noreferrer' className="py-3 text-light border-bottom border-primary"><i className="fa fa-whatsapp text-secondary me-2 fs-5"></i> +91-9873848046</Link>
                            <Link to="mailto:vishankchauhan@gmail.com" target='_blank' rel='noreferrer' className="py-3 text-light border-bottom border-primary"><i className="fas fa-envelope text-secondary me-2"></i> vishankchauhan@gmail.com</Link>
                        </div>
                    </div>
                    <div className="col-lg-2 col-md-6">
